...
text.write("Merry Christmas", font=("Apple Chancery", 20, "bold"), align="center") 
text.setposition(130, 140) 
text.color("dark green") 
text.write("Be", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write("Code", font=("Avenir", 30, "normal"), align="left") 
text.setx(70) 
